...
#  - run t5_c4_span_corruption: sh bigscience/scripts/run_on_all_vms.sh enc_dec_c4_span_corruption "cd code/architecture-objective; git pull; sh bigscience/scripts/launch_command_in_tmux.sh \"bash bigscience/scripts/pretrain.sh enc_dec_c4_span_corruption\""
