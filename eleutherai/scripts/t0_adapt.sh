...
MODEL_DIR="gs://neo-datasets/zphang/multitask/runs/testing/v1_t0"
...
save_freqmkdir -p $LOGS_PATH
dsa
#if
# dsfasfsa[[ $ORIGINAL_EXPERIMENT_NAME == c_dec* ]]
#then
...
PYTHONPATH=/home/connor/code/architecture-objective/bigscience/gins:${PYTHONPATH} python3 ${T5X_DIR}/t5x/train.py \
  --gin_file="$GIN_FILE" \
